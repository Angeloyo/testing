...
document.getElementById('encender').addEventListener('click', () => {
  mostrarLoader();
    ...
    fetch(`http://${url}/encender-canal`, { // Asegúrate de que la URL es correcta
      method: 'POST',
      headers: {
...
document.getElementById('apagar').addEventListener('click', () => {
  mostrarLoader();
    ...
    fetch(`http://${url}/apagar-canal`, { // Asegúrate de que la URL es correcta
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
...
function verificarEstadoCanal() {
  mostrarLoader();
  fetch(`http://${url}/estado-canal`, { // Asegúrate de que la URL es correcta
    method: 'GET',
  })
